...
public class Testbase1 {
	...
	public static void LoadingFiles() throws IOException {
		...
		extent = new ExtentReports(System.getProperty("user.dir") + "\\src\\test\\resources\\extendReport\\"
	...
	public static void launchingBrowser() {
		...
		if (config.getProperty("Browsers").equalsIgnoreCase("Chrome")) {
			System.setProperty("webdriver.chrome.driver",
					"D:\\rahul\\qsp\\Test27_sep\\src\\test\\resources\\driver\\chromedriver.exe");
			driver = new ChromeDriver();
		} else if (config.getProperty("Browsers").equalsIgnoreCase("firefox")) {
			System.setProperty("webdriver.gecko.driver",
					"D:\\rahul\\qsp\\Test27_sep\\src\\test\\resources\\driver\\geckodriver.exe");
